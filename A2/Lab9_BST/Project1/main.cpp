//#include "intBst.h"     // uncomment (and comment out Bst.h) for the non-templated demo
#include "Bst.h"
#include <iostream>
#include <fstream>
#include <string>

//typedef intBst Tree;    // non-templated version
typedef Bst<int> Tree;    // templated version
