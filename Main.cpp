...
void LoadFromFile(const std::string& fileName, intBst& tree)
{
...
void ShowTree(const intBst& tree)
{
...
void ModifyCopy(intBst treeCopy)
{
    treeCopy.Insert(999);
...
int main()
{
    intBst intTree;                        // non-templated declaration
